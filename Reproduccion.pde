...
void mutacion(Presa a){
  ...
  if ( i == 3) {
    a.dots = a.dots + (int) (Math.random()*4);
    a.dots = constrain(a.dots, 1, 45);
  }
  if ( i == 4) {
    a.metabolismo = a.metabolismo + (float)(rand.nextGaussian()*5);
    a.metabolismo = constrain(a.metabolismo, 5, 3000);
  }
  if ( i == 5) {
  ...
  if ( i == 9) {
    ...
    a.Fali = constrain(a.Fali, 0, 2);
  }
  if ( i == 10) {
    a.Fcoh = a.Fcoh + (float)(rand.nextGaussian()*0.1 );
    a.Fcoh = constrain(a.Fcoh, 0, 2);
  }
  if ( i == 11) {
